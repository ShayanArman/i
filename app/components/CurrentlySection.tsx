  ...
  if (!mounted) {
    return (
      <div className="flex flex-col gap-3">
        ...
        <p className="text-base text-gray-600">Building <LinkPreview href="https://zeroinbox.ai" className="transition-colors hover:opacity-80" style={{ color: 'var(--lab-color)' }}>Zero Inbox</LinkPreview>.</p>
