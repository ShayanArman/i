          ...
          <div className="flex flex-col gap-20 py-15">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-6 rounded-2xl border border-gray-200 bg-zinc-50 p-5 sm:p-6">
                ...
                <div className="-mx-5 w-[calc(100%+2.5rem)] overflow-hidden rounded-none border-y border-gray-200 bg-white pt-2 sm:mx-auto sm:w-full sm:max-w-[480px] sm:rounded-xl sm:border">
                  <iframe
