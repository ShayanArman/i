      ...
      <Flex mih="40rem" w="100%" align="center" className={classes.main}>
        <Flex direction={"column"} className={classes.content} gap={5}>
          <h1 className={classes.title}>
            GenRepo <span style={{ color: "var(--zero-red)" }}>AI</span>
          </h1>
          <h1 className={classes.subTitle}>
            Invoice <span style={{ color: "var(--zero-blue)" }}>Manager</span>
          </h1>
...
const description =
  "AI-powered Invoice Manager for Construction companies. Built with your team in mind. Save time, let Zero AI handle it.";
  ...
  return (
    <Box>
      ...
      <Button
        mt={"xl"}
        component="a"
        href="mailto:info@zeroinbox.ai?subject=GenRepo.ai: AI Invoice Manager for Construction Companies"
